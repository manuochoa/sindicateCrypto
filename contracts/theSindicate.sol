...
contract TheSindicate is ERC20Detailed, Ownable {
    ...
    uint256 private constant MAX_REBASE_FREQUENCY = 18000;
    ...
    address public stableCoin = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; // BUSD Testnet
    // address public stableCoin = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // BUSD Mainnet
    ...
    constructor() ERC20Detailed("The Sindicate", "$SIN", uint8(DECIMALS)) {
        router = IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // PancakeRouter Testnet
        // router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); // PancakeRouter Mainnet
