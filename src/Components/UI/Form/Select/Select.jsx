    ...
    return (
        <div className={classes.main}>
            <div className={classes.view} onClick={handleOpen}>
                ...
                <img src={arrow} alt="arrow" className={cx(classes.arrow, isOpen ? classes.active : "")}/>
            </div>
            {isOpen && <SelectTokenMenu tokens={tokens} setCurrentItem={onChange} onClose={handleOpen}/>}
        </div>
    )
}
