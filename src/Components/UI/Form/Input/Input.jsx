...
const Input = (props) => {
    ...
    return (
        <div className={cx(classes.main, label ? classes.relativeInput : undefined, onFocus ? classes.onFocus : undefined)}>
                ...
                InputProps={{
                    startAdornment: startAdornment && (
                        <InputAdornment position='start' style={{ width: "fit-content", marginRight: "10px" }}>
                            ...
                            {startAdornmentText && <p className={classes.adornmentText}>{startAdornmentText}</p>}
                        </InputAdornment>
                    ),
                    endAdornment: endAdornment && (
                        <InputAdornment position='end' style={{ width: "fit-content", marginRight: "10px" }}>
                            {endAdornmentComponent && endAdornmentComponent}
                            {endAdornmentText && <p className={classes.adornmentText}>{endAdornmentText}</p>}
                        </InputAdornment>
                    )
                }}
            />
